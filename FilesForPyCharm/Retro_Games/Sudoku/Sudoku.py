from sudoku_things import valid, solve, find_empty
...
cover = Image.open('/Users/hyunsukmbajonas/Downloads/dat_image.png')
...
def main():
    ...
    icon = pygame.image.load('/Users/hyunsukmbajonas/Downloads/dat_image.png')
