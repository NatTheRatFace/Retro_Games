...
font = TTFont('/Users/hyunsukmbajonas/Downloads/ArialRoundedMTBold (1).ttf')

font.save('/Users/hyunsukmbajonas/Downloads/ArialRoundedMTBold (1).ttf', reorderTables=True)

backdrop = Image.open('/Users/hyunsukmbajonas/Downloads/red_button.png')
button = Image.open('/Users/hyunsukmbajonas/Downloads/the_button.png')
...
BACKDROP = pygame.image.load('/Users/hyunsukmbajonas/Downloads/red_button.png')
WHITE_BUTTON = pygame.image.load('/Users/hyunsukmbajonas/Downloads/the_button.png')

FONT = pygame.font.Font('/Users/hyunsukmbajonas/Downloads/ArialRoundedMTBold (1).ttf', 120)
...
START_STOP_BUTTON = Button(WHITE_BUTTON, (WIDTH/2, HEIGHT/2+100), 170, 60, "START",
                    pygame.font.Font('/Users/hyunsukmbajonas/Downloads/ArialRoundedMTBold (1).ttf', 20), "#c97676", "#9ab034")
POMODORO_BUTTON = Button(None, (WIDTH/2-150, HEIGHT/2-140), 120, 30, "Pomodoro",
                    pygame.font.Font('/Users/hyunsukmbajonas/Downloads/ArialRoundedMTBold (1).ttf', 20), "#FFFFFF", "#9ab034")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if started:
                ...
                START_STOP_BUTTON.text = pygame.font.Font('/Users/hyunsukmbajonas/Downloads/ArialRoundedMTBold (1).ttf', 20).render(
